"""
Script to download YOLO models for the Minecraft Hand Gesture Controller
"""
        ...
        for model_name in selected_models:
            ...
            try:
                ...
                if not model_path.exists():
                    # The model is typically downloaded to the current directory or cache
                    # YOLO handles the download automatically
...
def download_hand_gesture_models():
    """Download or create hand gesture models."""
